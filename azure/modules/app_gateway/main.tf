...
#---------------------------
locals {
  frontend_port_name             = "mangoapp-${var.app_gateway_name}-${local.location}-frontendport"
  frontend_ip_configuration_name = "mangoapp-${var.app_gateway_name}-${local.location}-frontendip"
  gateway_ip_configuration_name  = "mangoapp-${var.app_gateway_name}-${local.location}-gatewayipconfiguration"
...
resource "azurerm_public_ip" "pip" {
  name                = lower("${var.app_gateway_name}-${local.location}-gateway-publicip")
...
resource "azurerm_application_gateway" "main" {
  name                = lower("Mangoapp-${var.app_gateway_name}-${local.location}")
  resource_group_name = local.resource_group_name
  location            = local.location
